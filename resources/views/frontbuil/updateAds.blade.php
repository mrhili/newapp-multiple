...
@endcomponent
    ...
    <div class="container" style="direction: rtl;">
                ...
                <div class="row">
                    ...
                    {!! Form::model($ads, ['route' => ['ads.update', $ads->id], 'files' => true, 'method' => 'post' ,'class' => 'form-horizontal', 'enctype' => 'multipart/form-data']) !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="contact-info">
                                    <h5>عنا صور</h5>
                                    <div>
                                        @foreach($ads->pics as $pic )
                                            <img src="{{ CommonPics::ifImg('ads', $pic->name ) }}" class="img-responsive" alt="{{$pic->name}}" width="30%"/>
                                            <a href="{{ route('pic.destroy', $pic->id )}}">Delete img</a>
                                        @endforeach
                                    </div>
                                </div>
